...
type Payload={kpis:Partial<Record<Period,number>>;kpi_details:Partial<Record<Period,KpiDetail>>;factory_periods:PeriodRow[];monthly:{month:string;eff_pct:number}[];last30:{produce_date:string;eff_pct:number}[];factory_monthly:{month:string;factory:string;eff_pct:number}[];factory_monthly_product:FactoryProduct[];latest_date:string|null;last_refresh:string};
