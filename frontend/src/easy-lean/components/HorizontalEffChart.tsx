...
export default function HorizontalEffChart({ data, selectedFactory, onSelect }: Props) {
  const option = {
    ...
    grid: { left: 48, right: 58, top: 28, bottom: 24, containLabel: true },
    ...
    series: [{
      ...
      markLine:{
        ...
        label:{show:true,formatter:"Target 65%",position:"insideStartTop",rotate:0,color:"#3561b6",fontWeight:700,fontSize:10,padding:[2,4],backgroundColor:"rgba(255,255,255,.94)",borderRadius:3},
        data:[{xAxis:TARGET}]
      }
    }],
  };
